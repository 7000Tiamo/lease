...
public class ApartmentController {
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        LambdaUpdateWrapper<ApartmentInfo> apartmentInfoWrapper = new LambdaUpdateWrapper<>();
        apartmentInfoWrapper.eq(ApartmentInfo::getId,id);
        apartmentInfoWrapper.set(ApartmentInfo::getIsRelease,status);
        apartmentInfoService.update(apartmentInfoWrapper);
        return Result.ok();
    }
